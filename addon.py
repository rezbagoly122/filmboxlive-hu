...
def build_url(query):
#    xbmcgui.Dialog().ok('',base_url + '?' + urllib.urlencode(query))	
...
####################
	    if url == 'http://spi-live.ercdn.net/spi/smil:filmboxhd_plczhu_3.smil/playlist.m3u8':
	           url = 'http://spi-live.ercdn.net/spi/smil:fb_extra_hu.smil/playlist.m3u8'
    	    if url == 'http://spi-live.ercdn.net/spi/smil:filmboxextra1sd_czhurosd_0.smil/playlist.m3u8':
	           url = 'http://spi-live.ercdn.net/spi/smil:fb_plus_hu.smil/playlist.m3u8'
####################
...
#    add_folder('Próba', '', {'mode': 'list', 'searchName': 'TVSER1'})
    add_folder('TV csatornák', '', {'mode': 'list', 'live': '1'})
    xbmcplugin.endOfDirectory(addon_handle)
